...
<style>
  ...
  .pulse-ticker-item {
    ...
    text-shadow: 0 2px 6px rgba(0,0,0,0.60), 0 0 12px rgba(0,0,0,0.40);
  }
  .pulse-ticker-item:hover { color: #FFFFFF; text-shadow: 0 2px 8px rgba(0,0,0,0.70), 0 0 16px rgba(0,0,0,0.50); }
